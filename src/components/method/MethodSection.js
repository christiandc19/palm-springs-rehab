...
{/* SECTION 4 - RECREATIONS */}
    ...
    <div className='treatment-section-activities'>
        <div className='treatment-left'>
            ...
            <p>
            Fremont Rehab Rehab promotes fun activities that clients learn how to develop interests and hobbies that helps then improve their mental health. Clients must be cleared by the doctor to participate. Organized activities may include but are not limited to:
            <ul> <br/>
                <li>
